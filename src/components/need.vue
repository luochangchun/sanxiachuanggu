            ...
            <div>
              <el-row :gutter="10">
                <el-col :lg="22" :md="22" :sm="22" :xs="22">
                  <h3 class="padder-v">行业分类
                    <router-link :to="{name:'problem', params: {type:'enterprise'}}" class="r show_need_btn">
                      发布问题
                    </router-link>
                  </h3>
                    ...
                    <el-tab-pane :label='item.value' :name="item.cname" :cid="item.id" v-for="(item, index) in category" :key="index">
                      ...
                      <el-row class="need_xq" style="background-color:#eee;">
                        ...
                        <el-col :lg="5" :md="5" :sm="5" :xs="5">
                          <p style="color:#000;padding-left:10px;">联系方式</p>
                        </el-col>
                        <el-col :lg="5" :md="5" :sm="5" :xs="5">
                          <p style="color:#000;padding-left:10px;">发布时间</p>
                        </el-col>
                      </el-row>
