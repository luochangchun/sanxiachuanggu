                      ...
                      <el-row :gutter="20" class="b-b m-t" >
                          ...
                          <el-col :span="16" class="pos" v-show="showread">
                              ...
                              <div class="pos-abt" style="bottom:15px;">
                                   <p class="text-muted pull-left m-r"><i class="el-icon-time fa fa-clock-o m-r-xs"></i><span>时间：2017-10-10</span></p>
                                   <p class="text-muted pull-left"><i class="el-icon-edit fa fa-edit m-r-xs"></i><span>创谷空间</span></p>
                              </div>
                          </el-col>
                          <!--点击图片进入详情-->
