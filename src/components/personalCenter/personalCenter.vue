<template>
    <div class="personalCenter">
        <div class="container" style="background-color:#fff;padding-left:0;padding-right:0;padding-bottom:100px;">
            <el-row>
                        ...
                        <el-menu router mode="vertical" default-active="/demand_comm_service/01" class="el-menu-vertical-demo center_left" theme="light">
                            <el-menu-item-group title="个人中心">
                                ...
                                <el-menu-item index="/demand_comm_service/03">
                                    <p>融资项目</p><i class="el-icon-arrow-right"></i></el-menu-item>
                            ...
                            <el-menu-item-group title="账号设置">
                                <el-menu-item index="/personalInformation">
                                    <p>个人资料</p><i class="el-icon-arrow-right"></i></el-menu-item>
                                <el-menu-item index="/passwordSetting">
                                    <p>密码设置</p><i class="el-icon-arrow-right"></i></el-menu-item>
                            </el-menu-item-group>
                        </el-menu>
                    </aside>
