...
@media all and (max-width: 768px) {
  ...
  #telnumber:hover span {
    display: block;
  }
  #telnumber span::after {
    border-left-color: rgba(6, 146, 63, 1);
    content: "";
    display: block;
    position: absolute;
    right: -26px;
  ...
  #qq span::after {
    border-left-color: rgba(244, 129, 0, 1);
    content: "";
    display: block;
    position: absolute;
    right: -26px;
  ...
  #code span::after {
    border-left-color: rgba(0, 137, 227, 0.8);
    content: "";
    display: block;
    position: absolute;
    right: -26px;
